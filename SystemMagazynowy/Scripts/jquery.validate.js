...
$.extend($.validator, {
	...
	messages: {
		...
		dateISO: "Wpisz poprawną datę (ISO).",
		...
		rangelength: $.validator.format("Wpisz wartość z przedziału {0} a {1} znaków."),
		range: $.validator.format("Wpisz wartość z przedziału {0} a {1}."),
